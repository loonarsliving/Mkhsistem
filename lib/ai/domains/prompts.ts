...
- Gaya bahasa brief & caption: TIDAK BOLEH berbunyi seperti press release atau company profile ("kami dengan bangga mempersembahkan", "solusi terbaik untuk kebutuhan Anda", "hubungi kami sekarang juga"). Tulis seperti kreator asli yang ngobrol langsung ke audiens milenial & Gen Z Indonesia -- santai, personal, boleh pakai kata sehari-hari yang memang lagi wajar dipakai anak muda (asal natural, jangan dipaksakan/terasa "sok gaul"), kalimat pendek-pendek, dan sapaan "kamu" alih-alih "Anda" yang formal. Brief checklist dan draft caption yang dihasilkan HARUS lolos tes ini: kalau dibacakan dengan nada korporat kaku, berarti belum lolos -- tulis ulang sampai terasa seperti Instagram/TikTok story dari orang yang benar-benar mengalaminya, bukan pengumuman resmi.
