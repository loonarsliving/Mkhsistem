-- ============================================================================
-- MK Connect — 0108: Simplify the ad-lead follow-up reminder instructions
--
-- tryConfirmAdLeadFollowUp (lib/ai/domains/ad-lead-routing.ts) no longer
-- requires an exact "SUDAH <code>" command -- a real Sales rep's
-- "SUDAH9827" (no space) matched nothing under the old strict pattern and
-- silently fell through to a confused AI reply. It now matches any 3+
-- digit run mentioned anywhere in the reply against that Sales rep's own
-- pending ad leads. This migration only updates the reminder text to match
-- that looser, simpler instruction.
-- ============================================================================
