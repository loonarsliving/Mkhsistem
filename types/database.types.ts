  ...
  public: {
    Tables: {
      ...
      mkc_file_categories: {
        ...
        Update: Partial<Database["public"]["Tables"]["mkc_file_categories"]["Insert"]>;
        Relationships: [
          {
            foreignKeyName: "mkc_file_categories_parent_id_fkey";
            columns: ["parent_id"];
            referencedRelation: "mkc_file_categories";
            referencedColumns: ["id"];
          },
        ];
      };
      mkc_files: {
        ...
        Update: Partial<Database["public"]["Tables"]["mkc_files"]["Insert"]>;
        Relationships: [
          {
            foreignKeyName: "mkc_files_category_id_fkey";
            columns: ["category_id"];
            referencedRelation: "mkc_file_categories";
            referencedColumns: ["id"];
          },
      ...
      mkc_file_requests: {
        Row: {
          ...
          status: "pending_match" | "matched" | "ambiguous" | "no_match" | "delivering" | "sent" | "failed";
        ...
        Update: Partial<Database["public"]["Tables"]["mkc_file_requests"]["Insert"]>;
        Relationships: [
          {
            foreignKeyName: "mkc_file_requests_requested_by_employee_id_fkey";
            columns: ["requested_by_employee_id"];
            referencedRelation: "employees";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "mkc_file_requests_matched_file_id_fkey";
            columns: ["matched_file_id"];
            referencedRelation: "mkc_files";
            referencedColumns: ["id"];
          },
        ];
      };
