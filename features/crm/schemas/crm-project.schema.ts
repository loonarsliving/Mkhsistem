...
import { PROJECT_TYPE, PROJECT_STATUS, OFFERING_TYPE } from "@/constants/app";
...
export const crmProjectSchema = z.object({
  ...
  offeringType: z.enum(Object.values(OFFERING_TYPE) as [string, ...string[]], { required_error: "Jenis penawaran wajib dipilih" }),
