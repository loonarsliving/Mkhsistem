...
export interface KontenAiStoryboardWithBrief extends Omit<KontenAiStoryboardRow, "scenes"> {
  ...
  creativeBrief: { product_project: string; objective: string; platform: string; big_idea: string; content_focus: string | null } | null;
}

const SELECT_COLUMNS =
  "id, creative_brief_id, title, scenes, total_duration_seconds, created_by, updated_by, created_at, updated_at, creativeBrief:creative_brief_id(product_project, objective, platform, big_idea, content_focus)";
